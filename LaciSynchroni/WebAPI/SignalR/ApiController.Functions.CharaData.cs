...
public partial class ApiController
{
    public async Task<CharaDataFullDto?> CharaDataCreate()
    {
        ...
        try
        {
            ...
            return await _serverHub!
                .InvokeAsync<CharaDataFullDto?>(nameof(CharaDataCreate))
    ...
    public async Task<CharaDataFullDto?> CharaDataUpdate(CharaDataUpdateDto updateDto)
    {
        ...
        try
        {
            ...
            return await _serverHub!
                .InvokeAsync<CharaDataFullDto?>(nameof(CharaDataUpdate), updateDto)
                .ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task<bool> CharaDataDelete(string id)
    {
        ...
        try
        {
            ...
            return await _serverHub!
                .InvokeAsync<bool>(nameof(CharaDataDelete), id)
                .ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task<CharaDataMetaInfoDto?> CharaDataGetMetainfo(string id)
    {
        ...
        try
        {
            ...
            return await _serverHub!
                .InvokeAsync<CharaDataMetaInfoDto?>(nameof(CharaDataGetMetainfo), id)
                .ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task<CharaDataFullDto?> CharaDataAttemptRestore(string id)
    {
        ...
        try
        {
            ...
            return await _serverHub!
                .InvokeAsync<CharaDataFullDto?>(nameof(CharaDataAttemptRestore), id)
                .ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task<List<CharaDataFullDto>> CharaDataGetOwn()
    {
        ...
        try
        {
            ...
            return await _serverHub!
                .InvokeAsync<List<CharaDataFullDto>>(nameof(CharaDataGetOwn))
                .ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task<List<CharaDataMetaInfoDto>> CharaDataGetShared()
    {
        ...
        try
        {
            Logger.LogDebug("Getting all own chara data");
            return await _serverHub!
                .InvokeAsync<List<CharaDataMetaInfoDto>>(nameof(CharaDataGetShared))
                .ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task<CharaDataDownloadDto?> CharaDataDownload(string id)
    {
        ...
        try
        {
            ...
            return await _serverHub!
                .InvokeAsync<CharaDataDownloadDto>(nameof(CharaDataDownload), id)
                .ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task<string> GposeLobbyCreate()
    {
        ...
        try
        {
            ...
            return await _serverHub!
                .InvokeAsync<string>(nameof(GposeLobbyCreate))
                .ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task<bool> GposeLobbyLeave()
    {
        ...
        try
        {
            ...
            return await _serverHub!
                .InvokeAsync<bool>(nameof(GposeLobbyLeave))
                .ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task<List<UserData>> GposeLobbyJoin(string lobbyId)
    {
        ...
        try
        {
            ...
            return await _serverHub!
                .InvokeAsync<List<UserData>>(nameof(GposeLobbyJoin), lobbyId)
                .ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task GposeLobbyPushCharacterData(CharaDataDownloadDto charaDownloadDto)
    {
        ...
        try
        {
            ...
            await _serverHub!
                .InvokeAsync(nameof(GposeLobbyPushCharacterData), charaDownloadDto)
                .ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task GposeLobbyPushPoseData(PoseData poseData)
    {
        ...
        try
        {
            ...
            await _serverHub!
                .InvokeAsync(nameof(GposeLobbyPushPoseData), poseData)
                .ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task GposeLobbyPushWorldData(WorldData worldData)
    {
        ...
        {
            await _serverHub!
                .InvokeAsync(nameof(GposeLobbyPushWorldData), worldData)
                .ConfigureAwait(false);
        }
        catch (Exception ex)
        {
