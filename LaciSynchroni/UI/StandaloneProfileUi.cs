...
public class StandaloneProfileUi : WindowMediatorSubscriberBase
{
    ...
    public StandaloneProfileUi(
        ...
        : base(
            ...
            "Laci Profile of "
                ...
                + "##LaciSynchroniStandaloneProfileUI"
                + pair.UserData.AliasOrUID,
    ...
    protected override void DrawInternal()
    {
        try
        {
            ...
            var syncProfile = _profileManager.GetSyncProfile(Pair.UserData);
            ...
            UiSharedService.ColorText(
                status,
                (Pair.IsVisible || Pair.IsOnline) ? ImGuiColors.HealerGreen : ImGuiColors.DalamudRed
            );
            if (Pair.IsVisible)
            {
                ImGui.SameLine();
            ...
            drawList.AddImage(
                ...
                new Vector2(
                    ...
                    rectMin.Y + spacing.Y + pos.Y + remainingHeight
                ),
                new Vector2(
                    rectMin.X + padding + remainingWidth + newWidth,
                    rectMin.Y + spacing.Y + pos.Y + remainingHeight + newHeight
                )
            );
