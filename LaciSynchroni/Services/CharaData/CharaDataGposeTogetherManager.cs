...
public class CharaDataGposeTogetherManager : DisposableMediatorSubscriberBase
{
    ...
    public CharaDataGposeTogetherManager(
        ILogger<CharaDataGposeTogetherManager> logger,
        SyncMediator mediator,
        ApiController apiController,
        IpcCallerBrio brio,
        DalamudUtilService dalamudUtil,
        VfxSpawnManager vfxSpawnManager,
        CharaDataFileHandler charaDataFileHandler,
        CharaDataManager charaDataManager
    )
        : base(logger, mediator)
    {
        Mediator.Subscribe<GposeLobbyUserJoin>(
            this,
            (msg) =>
            {
        ...
        Mediator.Subscribe<GPoseLobbyUserLeave>(
            this,
            (msg) =>
            {
        ...
        Mediator.Subscribe<GPoseLobbyReceiveCharaData>(
            this,
            (msg) =>
            {
        ...
        Mediator.Subscribe<GPoseLobbyReceivePoseData>(
            this,
            (msg) =>
            {
        ...
        Mediator.Subscribe<GPoseLobbyReceiveWorldData>(
            this,
            (msg) =>
            {
        ...
        Mediator.Subscribe<ConnectedMessage>(
            this,
            (msg) =>
            {
        ...
        Mediator.Subscribe<GposeEndMessage>(
            this,
            (msg) =>
            {
                OnExitGpose();
        ...
        Mediator.Subscribe<FrameworkUpdateMessage>(
            this,
            (msg) =>
            {
                OnFrameworkUpdate();
        ...
        Mediator.Subscribe<CutsceneFrameworkUpdateMessage>(
            this,
            (msg) =>
            {
        ...
        Mediator.Subscribe<DisconnectedMessage>(
            this,
            (msg) =>
            {
                LeaveGPoseLobby();
    ...
    public (bool SameMap, bool SameServer, bool SameEverything) IsOnSameMapAndServer(
        GposeLobbyUserData data
    )
    {
        return (
            data.Map.RowId == _lastWorldData?.LocationInfo.MapId,
            data.WorldData?.LocationInfo.ServerId == _lastWorldData?.LocationInfo.ServerId,
            data.WorldData?.LocationInfo == _lastWorldData?.LocationInfo
        );
    }
    ...
    public async Task PushCharacterDownloadDto()
    {
        ...
        if (
            !string.Equals(
                playerData.DataHash.Value,
                _lastCreatedCharaData?.ApiData.DataHash.Value,
        ...
        )
        {
            ...
            [
                .. playerData
                    .FileReplacements[Common.Data.Enum.ObjectKind.Player]
                    .Where(u => string.IsNullOrEmpty(u.FileSwapPath))
                    .SelectMany(
                        u => u.GamePaths,
                        (file, path) => new GamePathEntry(file.Hash, path)
                    ),
            ];
            List<GamePathEntry> fileSwapPaths =
            [
                .. playerData
                    .FileReplacements[Common.Data.Enum.ObjectKind.Player]
                    .Where(u => !string.IsNullOrEmpty(u.FileSwapPath))
                    .SelectMany(
                        u => u.GamePaths,
                        (file, path) => new GamePathEntry(file.FileSwapPath, path)
                    ),
            ];
            await _charaDataManager
                .UploadFiles(
                    [
                        .. playerData
                            .FileReplacements[Common.Data.Enum.ObjectKind.Player]
            ...
            CharaDataDownloadDto charaDataDownloadDto = new(
                $"GPOSELOBBY:{CurrentGPoseLobbyId}",
                new(_apiController.UID)
            )
            {
                UpdatedDate = DateTime.UtcNow,
                ManipulationData = playerData.ManipulationData,
                CustomizeData = playerData.CustomizePlusData[Common.Data.Enum.ObjectKind.Player],
                FileGamePaths = filegamePaths,
                FileSwaps = fileSwapPaths,
                GlamourerData = playerData.GlamourerData[Common.Data.Enum.ObjectKind.Player],
            };
        ...
        if (_lastCreatedCharaData != null)
            await _apiController
                .GposeLobbyPushCharacterData(_lastCreatedCharaData.Value.Dto)
                .ConfigureAwait(false);
    }
    ...
    private string CreateJsonFromPoseData(PoseData? poseData)
    {
        ...
        foreach (var bone in poseData.Value.Bones)
        {
            ...
            node["Bones"]![bone.Key]!["Position"] =
                $"{bone.Value.PositionX.ToString(CultureInfo.InvariantCulture)}, {bone.Value.PositionY.ToString(CultureInfo.InvariantCulture)}, {bone.Value.PositionZ.ToString(CultureInfo.InvariantCulture)}";
            node["Bones"]![bone.Key]!["Scale"] =
                $"{bone.Value.ScaleX.ToString(CultureInfo.InvariantCulture)}, {bone.Value.ScaleY.ToString(CultureInfo.InvariantCulture)}, {bone.Value.ScaleZ.ToString(CultureInfo.InvariantCulture)}";
            node["Bones"]![bone.Key]!["Rotation"] =
                $"{bone.Value.RotationX.ToString(CultureInfo.InvariantCulture)}, {bone.Value.RotationY.ToString(CultureInfo.InvariantCulture)}, {bone.Value.RotationZ.ToString(CultureInfo.InvariantCulture)}, {bone.Value.RotationW.ToString(CultureInfo.InvariantCulture)}";
        }
        node["MainHand"] = new JsonObject();
        foreach (var bone in poseData.Value.MainHand)
        {
            node["MainHand"]![bone.Key] = new JsonObject();
            node["MainHand"]![bone.Key]!["Position"] =
                $"{bone.Value.PositionX.ToString(CultureInfo.InvariantCulture)}, {bone.Value.PositionY.ToString(CultureInfo.InvariantCulture)}, {bone.Value.PositionZ.ToString(CultureInfo.InvariantCulture)}";
            node["MainHand"]![bone.Key]!["Scale"] =
                $"{bone.Value.ScaleX.ToString(CultureInfo.InvariantCulture)}, {bone.Value.ScaleY.ToString(CultureInfo.InvariantCulture)}, {bone.Value.ScaleZ.ToString(CultureInfo.InvariantCulture)}";
            node["MainHand"]![bone.Key]!["Rotation"] =
                $"{bone.Value.RotationX.ToString(CultureInfo.InvariantCulture)}, {bone.Value.RotationY.ToString(CultureInfo.InvariantCulture)}, {bone.Value.RotationZ.ToString(CultureInfo.InvariantCulture)}, {bone.Value.RotationW.ToString(CultureInfo.InvariantCulture)}";
        }
        ...
        foreach (var bone in poseData.Value.OffHand)
        {
            ...
            node["OffHand"]![bone.Key]!["Position"] =
                $"{bone.Value.PositionX.ToString(CultureInfo.InvariantCulture)}, {bone.Value.PositionY.ToString(CultureInfo.InvariantCulture)}, {bone.Value.PositionZ.ToString(CultureInfo.InvariantCulture)}";
            node["OffHand"]![bone.Key]!["Scale"] =
                $"{bone.Value.ScaleX.ToString(CultureInfo.InvariantCulture)}, {bone.Value.ScaleY.ToString(CultureInfo.InvariantCulture)}, {bone.Value.ScaleZ.ToString(CultureInfo.InvariantCulture)}";
            node["OffHand"]![bone.Key]!["Rotation"] =
                $"{bone.Value.RotationX.ToString(CultureInfo.InvariantCulture)}, {bone.Value.RotationY.ToString(CultureInfo.InvariantCulture)}, {bone.Value.RotationZ.ToString(CultureInfo.InvariantCulture)}, {bone.Value.RotationW.ToString(CultureInfo.InvariantCulture)}";
        }
    ...
    private PoseData CreatePoseDataFromJson(string json, PoseData? fullPoseData = null)
    {
        ...
        foreach (var bone in bones)
        {
            ...
            {
                if (
                    fullPoseData.Value.Bones.TryGetValue(name, out var prevBoneData)
                    && prevBoneData != outputBoneData
                )
                {
        ...
        foreach (var bone in mainHand)
        {
            ...
            {
                if (
                    fullPoseData.Value.MainHand.TryGetValue(name, out var prevBoneData)
                    && prevBoneData != outputBoneData
                )
                {
        ...
        foreach (var bone in offhand)
        {
            ...
            {
                if (
                    fullPoseData.Value.OffHand.TryGetValue(name, out var prevBoneData)
                    && prevBoneData != outputBoneData
                )
                {
        ...
        while (!ct.IsCancellationRequested)
        {
            ...
            try
            {
                ...
                bool deltaIsSame =
                    _lastDeltaPoseData != null
                    && (
                        poseData.Bones.Keys.All(k =>
                            _lastDeltaPoseData.Value.Bones.ContainsKey(k)
                            && poseData.Bones.Values.All(k =>
                                _lastDeltaPoseData.Value.Bones.ContainsValue(k)
                            )
                        )
                    );

                if (
                    _forceResendFullPose
                    || (
                        (poseData.Bones.Any() || poseData.MainHand.Any() || poseData.OffHand.Any())
    ...
    private async Task GposeWorldPositionBackgroundTask(CancellationToken ct)
    {
        while (!ct.IsCancellationRequested)
        {
            await Task.Delay(TimeSpan.FromSeconds(_dalamudUtil.IsInGpose ? 10 : 1), ct)
                .ConfigureAwait(false);
            ...
            {
                // get own player data
                var player = (Dalamud.Game.ClientState.Objects.Types.ICharacter?)(
                    await _dalamudUtil.GetPlayerCharacterAsync().ConfigureAwait(false)
                );
                if (player == null)
                    continue;
                WorldData worldData;
                if (_dalamudUtil.IsInGpose)
                {
                    player = await _dalamudUtil
                        .GetGposeCharacterFromObjectTableByNameAsync(player.Name.TextValue, true)
                        .ConfigureAwait(false);
                    if (player == null)
                        continue;
                    worldData = (
                        await _brio.GetTransformAsync(player.Address).ConfigureAwait(false)
                    );
                }
                else
                {
                    var rotQuaternion = Quaternion.CreateFromAxisAngle(
                        new Vector3(0, 1, 0),
                        player.Rotation
                    );
                    worldData = new()
                ...
                {
                    if (
                        !entry.Value.HasWorldDataUpdate
                        || _dalamudUtil.IsInGpose
                        || entry.Value.WorldData == null
                    )
                        continue;
                    ...
                    if (
                        worldData.LocationInfo.MapId == entryWorldData.LocationInfo.MapId
                        && worldData.LocationInfo.DivisionId
                            == entryWorldData.LocationInfo.DivisionId
                        && (
                            ...
                            || entryWorldData.LocationInfo.ServerId
                                != worldData.LocationInfo.ServerId
                        )
                    )
                    {
                        if (entry.Value.SpawnedVfxId == null)
                        {
                            ...
                            entry.Value.LastWorldPosition = new Vector3(
                                entryWorldData.PositionX,
                                entryWorldData.PositionY,
                                entryWorldData.PositionZ
                            );
                            entry.Value.SpawnedVfxId = await _dalamudUtil
                                .RunOnFrameworkThread(() =>
                                    _vfxSpawnManager.SpawnObject(
                                        entry.Value.LastWorldPosition.Value,
                                        Quaternion.Identity,
                                        Vector3.One,
                                        0.5f,
                                        0.1f,
    ...
    private void OnCutsceneFrameworkUpdate()
    {
        foreach (var kvp in _usersInLobby)
        {
            if (!string.IsNullOrWhiteSpace(kvp.Value.AssociatedCharaName))
            {
                kvp.Value.Address =
                    _dalamudUtil
                        .GetGposeCharacterFromObjectTableByName(kvp.Value.AssociatedCharaName, true)
                        ?.Address ?? nint.Zero;
            ...
            if (
                kvp.Value.Address != nint.Zero
                && (kvp.Value.HasWorldDataUpdate || kvp.Value.HasPoseDataUpdate)
            )
            {
                ...
                _ = Task.Run(async () =>
                {
                    if (hadPoseDataUpdate && kvp.Value.ApplicablePoseData != null)
                    {
                        await _brio
                            .SetPoseAsync(
                                kvp.Value.Address,
                                CreateJsonFromPoseData(kvp.Value.ApplicablePoseData)
                            )
                            .ConfigureAwait(false);
                    }
                    ...
                    {
                        await _brio
                            .ApplyTransformAsync(kvp.Value.Address, kvp.Value.WorldData.Value)
                            .ConfigureAwait(false);
                    }
                });
            }
    ...
    private void OnFrameworkUpdate()
    {
        ...
        foreach (var kvp in _usersInLobby)
        {
            ...
            {
                var secondsElasped = frameworkTime
                    .Subtract(kvp.Value.UpdateStart.Value)
                    .TotalSeconds;
                if (secondsElasped >= 1)
                {
                ...
                else
                {
                    var lerp = Vector3.Lerp(
                        kvp.Value.LastWorldPosition ?? Vector3.One,
                        kvp.Value.TargetWorldPosition ?? Vector3.One,
                        (float)secondsElasped
                    );
    ...
    {
        if (
            userData.CharaData == null
            || userData.Address == nint.Zero
            || string.IsNullOrEmpty(userData.AssociatedCharaName)
        )
            return;
        ...
        {
            await _charaDataManager
                .ApplyCharaData(userData.CharaData!, userData.AssociatedCharaName)
                .ConfigureAwait(false);
    ...
    internal async Task SpawnAndApplyData(GposeLobbyUserData userData)
    {
        ...
        try
        {
            ...
            var chara = await _charaDataManager
                .SpawnAndApplyData(userData.CharaData)
                .ConfigureAwait(false);
            if (chara == null)
                return;
