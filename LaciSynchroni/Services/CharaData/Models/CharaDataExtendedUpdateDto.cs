...
public sealed record CharaDataExtendedUpdateDto : CharaDataUpdateDto
{
        ...
        : base(dto)
    {
        ...
        _poseList = charaDataFullDto
            .PoseData.Select(k => new PoseEntry(k.Id)
            {
    ...
    public CharaDataUpdateDto BaseDto =>
        new(Id)
        {
    ...
    {
        get { return base.ManipulationData ?? _charaDataFullDto.ManipulationData; }
        set
        {
            base.ManipulationData = value;
            if (
                string.Equals(
                    base.ManipulationData,
                    _charaDataFullDto.ManipulationData,
    ...
    {
        get { return base.Description ?? _charaDataFullDto.Description; }
        set
        {
    ...
    {
        get { return base.ExpiryDate ?? _charaDataFullDto.ExpiryDate; }
        private set
        {
    ...
    {
        get { return base.AccessType ?? _charaDataFullDto.AccessType; }
        set
        {
    ...
    {
        get { return base.ShareType ?? _charaDataFullDto.ShareType; }
        set
        {
    ...
    {
        get { return base.FileGamePaths ?? _charaDataFullDto.FileGamePaths; }
        set
        {
            base.FileGamePaths = value;
            if (
                !(base.FileGamePaths ?? []).Except(_charaDataFullDto.FileGamePaths).Any()
    ...
    {
        get { return base.FileSwaps ?? _charaDataFullDto.FileSwaps; }
        set
        {
            base.FileSwaps = value;
            if (
                !(base.FileSwaps ?? []).Except(_charaDataFullDto.FileSwaps).Any()
    ...
    {
        get { return base.GlamourerData ?? _charaDataFullDto.GlamourerData; }
        set
        {
            ...
            if (
                string.Equals(
                    base.GlamourerData,
                    _charaDataFullDto.GlamourerData,
                    StringComparison.Ordinal
                )
            )
            {
    ...
    {
        get { return base.CustomizeData ?? _charaDataFullDto.CustomizeData; }
        set
        {
            ...
            if (
                string.Equals(
                    base.CustomizeData,
                    _charaDataFullDto.CustomizeData,
                    StringComparison.Ordinal
                )
            )
            {
    ...
    private void UpdateAllowedUsers()
    {
        ...
        if (
            !AllowedUsers
                .Except(_charaDataFullDto.AllowedUsers.Select(u => u.UID), StringComparer.Ordinal)
                .Any()
            && !_charaDataFullDto
                .AllowedUsers.Select(u => u.UID)
                .Except(AllowedUsers, StringComparer.Ordinal)
                .Any()
        )
        {
            AllowedUsers = null;
    ...
    private void UpdateAllowedGroups()
    {
        ...
        if (
            !AllowedGroups
                .Except(_charaDataFullDto.AllowedGroups.Select(u => u.GID), StringComparer.Ordinal)
                .Any()
            && !_charaDataFullDto
                .AllowedGroups.Select(u => u.GID)
                .Except(AllowedGroups, StringComparer.Ordinal)
                .Any()
        )
        {
            AllowedGroups = null;
    ...
    public void UpdatePoseList()
    {
        Poses = [.. _poseList];
        if (
            !Poses.Except(_charaDataFullDto.PoseData).Any()
            && !_charaDataFullDto.PoseData.Except(Poses).Any()
        )
        {
            Poses = null;
        }
    ...
    internal void UndoChanges()
    {
        ...
        _poseList.Clear();
        _poseList.AddRange(
            _charaDataFullDto.PoseData.Select(k => new PoseEntry(k.Id)
            {
                Description = k.Description,
                PoseData = k.PoseData,
                WorldData = k.WorldData,
