...
public sealed record CharaDataMetaInfoExtendedDto : CharaDataMetaInfoDto
{
    ...
    public static async Task<CharaDataMetaInfoExtendedDto> Create(
        CharaDataMetaInfoDto baseMeta,
    ...
    )
    {
        ...
        {
            newDto.PoseExtended.Add(
                await PoseEntryExtended
                    .Create(pose, newDto, dalamudUtilService)
