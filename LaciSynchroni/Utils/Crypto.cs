...
#pragma warning disable SYSLIB0021 // Type or member is obsolete
    ...
    private static readonly Dictionary<string, string> _hashListSHA256 = new(
    ...
    public static string GetFileHash(this string filePath)
    {
        ...
        return BitConverter
            .ToString(cryptoProvider.ComputeHash(File.ReadAllBytes(filePath)))
    ...
    public static string GetHash256(this (string, ushort) playerToHash)
    {
        ...
        return _hashListPlayersSHA256[playerToHash] = BitConverter
            .ToString(
                _sha256CryptoProvider.ComputeHash(
                    Encoding.UTF8.GetBytes(playerToHash.Item1 + playerToHash.Item2.ToString())
                )
            )
            .Replace("-", "", StringComparison.Ordinal);
    }
    ...
    private static string GetOrComputeHashSHA256(string stringToCompute)
    {
        ...
        return _hashListSHA256[stringToCompute] = BitConverter
            .ToString(_sha256CryptoProvider.ComputeHash(Encoding.UTF8.GetBytes(stringToCompute)))
            .Replace("-", "", StringComparison.Ordinal);
    }
