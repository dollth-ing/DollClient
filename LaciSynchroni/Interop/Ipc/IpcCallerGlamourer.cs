            ...
            if (!apiAvailable && !_shownGlamourerUnavailable)
            {
                ...
                _syncMediator.Publish(
                    new NotificationMessage(
                        "Glamourer inactive",
                        "Your Glamourer installation is not active or out of date. Update Glamourer to continue to use Laci. If you just updated Glamourer, ignore this message.",
            ...
            await _redrawManager
                .PenumbraRedrawInternalAsync(
                    ...
                    (chara) =>
                    {
                        ...
                        {
                            logger.LogDebug(
                                "[{appid}] Calling on IPC: GlamourerApplyAll",
                                applicationId
                            );
                        ...
                        catch (Exception ex)
                        {
                            logger.LogWarning(
                                ex,
                                "[{appid}] Failed to apply Glamourer data",
                                applicationId
                            );
                        }
                    },
        ...
        try
        {
            return await _dalamudUtil
                .RunOnFrameworkThread(() =>
                {
                    ...
                    {
                        return _glamourerGetAllCustomization!.Invoke(c.ObjectIndex).Item2
                            ?? string.Empty;
                    }
                    return string.Empty;
                })
            ...
            await _redrawManager
                .PenumbraRedrawInternalAsync(
                    ...
                    (chara) =>
                    {
                        ...
                        {
                            logger.LogDebug(
                                "[{appid}] Calling On IPC: GlamourerUnlockName",
                                applicationId
                            );
                            _glamourerUnlock.Invoke(chara.ObjectIndex, LockCode);
                            logger.LogDebug(
                                "[{appid}] Calling On IPC: GlamourerRevert",
                                applicationId
                            );
                            _glamourerRevert.Invoke(chara.ObjectIndex, LockCode);
                            logger.LogDebug(
                                "[{appid}] Calling On IPC: PenumbraRedraw",
                                applicationId
                            );
                        ...
                        catch (Exception ex)
                        {
                            logger.LogWarning(
                                ex,
                                "[{appid}] Error during GlamourerRevert",
                                applicationId
                            );
                        }
                    },
