...
public sealed class IpcCallerHeels : IIpcCaller
{
    ...
    public IpcCallerHeels(
        ILogger<IpcCallerHeels> logger,
    ...
    )
    {
        ...
        _heelsRegisterPlayer = pi.GetIpcSubscriber<int, string, object?>(
    ...
    public async Task<string> GetOffsetAsync()
    {
        ...
        return await _dalamudUtil
            .RunOnFrameworkThread(_heelsGetOffset.InvokeFunc)
