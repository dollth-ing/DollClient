...
{
    private static readonly byte[] _pool =
        "Client.System.Scheduler.Instance.VfxObject\0"u8.ToArray();
    ...
    public VfxSpawnManager(
        ILogger<VfxSpawnManager> logger,
        ...
        : base(logger, syncMediator)
    {
        ...
        syncMediator.Subscribe<GposeStartMessage>(
            this,
            (msg) =>
            {
        ...
        syncMediator.Subscribe<GposeEndMessage>(
            this,
            (msg) =>
            {
        ...
        syncMediator.Subscribe<CutsceneStartMessage>(
            this,
            (msg) =>
            {
                ChangeSpawnVisibility(0f);
        ...
        syncMediator.Subscribe<CutsceneEndMessage>(
            this,
            (msg) =>
            {
                RestoreSpawnVisiblity();
    ...
    )
    {
        ...
        var vfx = SpawnStatic(
            "bgcommon/world/common/vfx_for_event/eff/b0150_eext_y.avfx",
            position,
            rotation,
            r,
            g,
